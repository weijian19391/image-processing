...
def generate_panorama(left_view, mid_view, right_view):
    ...
    frame_count = video_capture_left.get(cv.CV_CAP_PROP_FRAME_COUNT)
    ...
    #video_output_size = (2560, 1920)
    #video_writer = cv2.VideoWriter('football_panorama.avi', cv.CV_FOURCC('3','I','V','D'), fps, video_output_size)
