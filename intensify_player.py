...
def drawPlayerOutline(frame,contours):
...
if __name__ == "__main__":
	...
	while capture.isOpened():
		...
		contoured_frame_red, blue_players_limbs = drawPlayerOutline(contoured_frame, contours)
		...
		contoured_frame_players,_ = drawPlayerOutline(contoured_frame_red, contours)
